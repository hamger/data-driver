...
export class DD extends Event {
  ...
  _init (options: GeneralObj) {
    let dd: any = this

    // 合并配置项
    dd.$options = mergeOptions(dd.constructor.options, options, dd)
  ...
  $watch (getter: string | Function, callback: Function, option?: GeneralObj) {
    let dd: any = this
